	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				<div class="panel-heading">Your Remindr</div>
				...
				<div class="panel-body">
					...
					<a href="{{ url('remindr/' . $reminder->id . '/edit') }}" class="btn btn-primary pull-left" style="margin-right: 3px;">Edit</a>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<p>Deleteing your remindr is not reversible.</p>
